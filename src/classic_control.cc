...
// typedef PyEnvSpec<classic_control::CurlingSimpleEnvSpec>
// CurlingSimpleEnvSpec;
// // generate python-side (raw) CurlingEnvPool
// typedef PyEnvPool<classic_control::CurlingSimpleEnvPool>
// CurlingSimpleEnvPool; generate classic_control_envpool.so

class Publicist
    : public OlympicsBase { // helper type for exposing protected functions
public:
  using OlympicsBase::map, OlympicsBase::obs_boundary, OlympicsBase::agent_num,
      OlympicsBase::reset,
      OlympicsBase::agent_init_pos; // inherited with different access modifier
};
...
PYBIND11_MODULE(classic_control_envpool, m) {
  ...
  py::class_<object_t>(m, "object_t").def_readwrite("_color", &object_t::color);
  ...
  py::class_<OlympicsBase>(m, "_OlympicsBase")
      ...
      //   py::return_value_policy::reference_internal) .def("get_obs",
      //   &OlympicsBase::get_obs, py::return_value_policy::reference_internal)
      //   .def("stepPhysics", &OlympicsBase::stepPhysics,
      //   py::return_value_policy::reference_internal) .def("add_agent",
      //   &OlympicsBase::add_agent,
      //   py::return_value_policy::reference_internal) .def("clear_agent",
      //   &OlympicsBase::clear_agent,
      ...
      .def("merge_map", &OlympicsBase::merge_map)
      .def("init_state", &OlympicsBase::init_state)
      .def("_generate_map", &OlympicsBase::generate_map)
      ...
      .def_readwrite("done", &OlympicsBase::done)
